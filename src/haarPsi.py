...
def haar_psi(reference_image, distorted_image, distorted_image_name , preprocess_with_subsampling = True):
    """
    ...
    if is_numpy(reference_image) and is_numpy(distorted_image):
        return haar_psi_numpy(reference_image, distorted_image, preprocess_with_subsampling), distorted_image_name
